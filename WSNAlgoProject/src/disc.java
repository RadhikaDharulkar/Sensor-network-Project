...
public class disc extends PApplet implements java.lang.Cloneable {
	...
	int d = 34;
	//double r=0.4*512;
	double r = 512 * sqrt((d+1)/ (PI * randomPoints));
	...
	public void setup() {
		...
		textSize(16);
		output = createWriter("C:/Users/rd28d/Desktop//AlgoOut/graph/colorDistribution.txt");
		output2 = createWriter("C:/Users/rd28d/Desktop/AlgoOut/graph/originaldegre.txt");
		output3 = createWriter("C:/Users/rd28d/Desktop/AlgoOut/graph/avgdegree.txt");
		output4 = createWriter("C:/Users/rd28d/Desktop//AlgoOut/graph/priset.txt");
	...
	public void draw() {
		...
		fill(0);
		text("Display Edges", rectX+10, rect1Y+20);
		
		stroke(204, 102, 0);
		fill(120);
		rect(rectX, rect2Y, rectW, rectH);
		fill(0);
		text("Display min", rectX+10, rect2Y+20);
		text("and max", rectX+20, rect2Y+30);
		
		stroke(204, 102, 0);
		fill(128);
		rect(rectX, rect3Y, rectW, rectH);
		fill(0);
		text("Smallest last", rectX+10, rect3Y+20);
		
		stroke(204, 102, 0);
		fill(128);
		rect(rectX, rect4Y, rectW, rectH);
		fill(0);
		text("Colouring", rectX+10, rect4Y+20);
		
		stroke(204, 102, 0);
		fill(128);
		rect(rectX, rect5Y, rectW, rectH);
		fill(0);
		text("Bipartite", rectX+10, rect5Y+20);
	...
	public void keyPressed() {
		...
		if (key == 's' || key == 'S') {
			...
			while (true) {
				...
				if(min==0 && max==0){vertices=0; break; }
				min = 1000000;
				max = 0;
				vertices = 0;
				for (int i = 0; i < rsp.maxPoints; i++) {
	...
	class randomSpherePoints {
		...
		void draw() {
			...
			text((int)avg2, -330, -120);

			text("Threshold: ", -495, -90);
			text((float)(r / 512), -330, -90);
